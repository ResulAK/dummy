 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Q(new b("messaging",On,"PUBLIC")),Q(new b("messaging-internal",Bn,"PRIVATE")),re(Tn,An),re(Tn,An,"esm2017");console.log("Iframe Loaded");const Nn=function(e=function(e=q){const t=J.get(e);if(!t&&e===q&&s())return ne();if(!t)throw ee.create("no-app",{appName:e});return t}()){return Ln().then((e=>{if(!e)throw pn.create("unsupported-browser")}),(e=>{throw pn.create("indexed-db-unsupported")})),X(m(e),"messaging").getImmediate()}(ne({apiKey:"AIzaSyAZ52vwi0JyQi9-I8rsbvefdbuZsUxaW5w",authDomain:"onelinesdktest.firebaseapp.com",projectId:"onelinesdktest",storageBucket:"onelinesdktest.appspot.com",messagingSenderId:"537523308807",appId:"1:537523308807:web:56544f6c4d3a5ae1b61da2",measurementId:"G-56S9V77FTV"}));Notification.requestPermission().then((e=>{setTimeout((()=>{navigator.serviceWorker.register("./sw.js").then((e=>{(async function(e,t){return _n(e=m(e),t)})(Nn,{serviceWorkerRegistration:e}).then((e=>{console.log("Got Token: ",e)})),console.log("Service worker registered")}))}),5e3)}))}();
