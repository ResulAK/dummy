 ...
 * limitations under the License.
 */
class W{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map((e=>{if(function(e){const t=e.getComponent();return"VERSION"===(null==t?void 0:t.type)}(e)){const t=e.getImmediate();return`${t.library}/${t.version}`}return null})).filter((e=>e)).join(" ")}}const K="@firebase/app",U="0.9.23",z=new class{constructor(e){this.name=e,this._logLevel=E,this._logHandler=_,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in I))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel="string"==typeof e?S[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if("function"!=typeof e)throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,I.DEBUG,...e),this._logHandler(this,I.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,I.VERBOSE,...e),this._logHandler(this,I.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,I.INFO,...e),this._logHandler(this,I.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,I.WARN,...e),this._logHandler(this,I.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,I.ERROR,...e),this._logHandler(this,I.ERROR,...e)}}("@firebase/app"),q="[DEFAULT]",G={[K]:"fire-core","@firebase/app-compat":"fire-core-compat","@firebase/analytics":"fire-analytics","@firebase/analytics-compat":"fire-analytics-compat","@firebase/app-check":"fire-app-check","@firebase/app-check-compat":"fire-app-check-compat","@firebase/auth":"fire-auth","@firebase/auth-compat":"fire-auth-compat","@firebase/database":"fire-rtdb","@firebase/database-compat":"fire-rtdb-compat","@firebase/functions":"fire-fn","@firebase/functions-compat":"fire-fn-compat","@firebase/installations":"fire-iid","@firebase/installations-compat":"fire-iid-compat","@firebase/messaging":"fire-fcm","@firebase/messaging-compat":"fire-fcm-compat","@firebase/performance":"fire-perf","@firebase/performance-compat":"fire-perf-compat","@firebase/remote-config":"fire-rc","@firebase/remote-config-compat":"fire-rc-compat","@firebase/storage":"fire-gcs","@firebase/storage-compat":"fire-gcs-compat","@firebase/firestore":"fire-fst","@firebase/firestore-compat":"fire-fst-compat","fire-js":"fire-js",firebase:"fire-js-all"},J=new Map,Y=new Map;function Z(e,t){try{e.container.addComponent(t)}catch(n){z.debug(`Component ${t.name} failed to register with FirebaseApp ${e.name}`,n)}}function Q(e){const t=e.name;if(Y.has(t))return z.debug(`There were multiple attempts to register component ${t}.`),!1;Y.set(t,e);for(const t of J.values())Z(t,e);return!0}function X(e,t){const n=e.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),e.container.getProvider(t)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var ge;ge="",Q(new b("platform-logger",(e=>new W(e)),"PRIVATE")),Q(new b("heartbeat",(e=>new le(e)),"PRIVATE")),re(K,U,ge),re(K,U,"esm2017"),re("fire-js","");
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ve({projectId:e}){return`${Re}/projects/${e}/installations`}function We(e){return{token:e.token,requestStatus:2,expiresIn:(t=e.expiresIn,Number(t.replace("s","000"))),creationTime:Date.now()};var t}async function Ke(e,t){const n=(await t.json()).error;return He.create("request-failed",{requestName:e,serverCode:n.code,serverMessage:n.message,serverStatus:n.status})}function Ue({apiKey:e}){return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":e})}function ze(e,{refreshToken:t}){const n=Ue(e);return n.append("Authorization",function(e){return`${$e} ${e}`}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
const Je=/^[cdef][\w-]{21}$/,Ye="";function Ze(){try{const e=new Uint8Array(17);(self.crypto||self.msCrypto).getRandomValues(e),e[0]=112+e[0]%16;const t=function(e){const t=(n=e,btoa(String.fromCharCode(...n)).replace(/\+/g,"-").replace(/\//g,"_"));var n;return t.substr(0,22)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e);return Je.test(t)?t:Ye}catch(e){return Ye}}function Qe(e){return`${e.appName}!${e.appId}`}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xe=new Map;function et(e,t){const n=Qe(e);tt(n,t),function(e,t){const n=function(){!nt&&"BroadcastChannel"in self&&(nt=new BroadcastChannel("[Firebase] FID Change"),nt.onmessage=e=>{tt(e.data.key,e.data.fid)});return nt}();n&&n.postMessage({key:e,fid:t});0===Xe.size&&nt&&(nt.close(),nt=null)}(n,t)}function tt(e,t){const n=Xe.get(e);if(n)for(const e of n)e(t)}let nt=null;
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
const rt="firebase-installations-database",it=1,at="firebase-installations-store";let ot=null;function st(){return ot||(ot=function(e,t,{blocked:n,upgrade:r,blocking:i,terminated:a}={}){const o=indexedDB.open(e,t),s=ke(o);return r&&o.addEventListener("upgradeneeded",(e=>{r(ke(o.result),e.oldVersion,e.newVersion,ke(o.transaction))})),n&&o.addEventListener("blocked",(()=>n())),s.then((e=>{a&&e.addEventListener("close",(()=>a())),i&&e.addEventListener("versionchange",(()=>i()))})).catch((()=>{})),s}(rt,it,{upgrade:(e,t)=>{if(0===t)e.createObjectStore(at)}})),ot}async function ct(e,t){const n=Qe(e),r=(await st()).transaction(at,"readwrite"),i=r.objectStore(at),a=await i.get(n);return await i.put(t,n),await r.done,a&&a.fid===t.fid||et(e,t.fid),t}async function ut(e){const t=Qe(e),n=(await st()).transaction(at,"readwrite");await n.objectStore(at).delete(t),await n.done}async function dt(e,t){const n=Qe(e),r=(await st()).transaction(at,"readwrite"),i=r.objectStore(at),a=await i.get(n),o=t(a);return void 0===o?await i.delete(n):await i.put(o,n),await r.done,!o||a&&a.fid===o.fid||et(e,o.fid),o}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
const Wt="/firebase-messaging-sw.js",Kt="/firebase-cloud-messaging-push-scope",Ut="BDOU99-h67HcA6JeFXHbSNMu7e2yNNu3RzoMj8TM4W88jITfq7ZmPvIM1Iv-4_l2LxQcYwhqby2xGpWwzjfAnG4",zt="https://fcmregistrations.googleapis.com/v1",qt="google.c.a.c_id",Gt="google.c.a.c_l",Jt="google.c.a.ts";var Yt,Zt;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function Qt(e){const t=new Uint8Array(e);return btoa(String.fromCharCode(...t)).replace(/=/g,"").replace(/\+/g,"-").replace(/\//g,"_")}function Xt(e){const t=(e+"=".repeat((4-e.length%4)%4)).replace(/\-/g,"+").replace(/_/g,"/"),n=atob(t),r=new Uint8Array(n.length);for(let e=0;e<n.length;++e)r[e]=n.charCodeAt(e);return r}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */!function(e){e[e.DATA_MESSAGE=1]="DATA_MESSAGE",e[e.DISPLAY_NOTIFICATION=3]="DISPLAY_NOTIFICATION"}(Yt||(Yt={})),function(e){e.PUSH_RECEIVED="push-received",e.NOTIFICATION_CLICKED="notification-clicked"}(Zt||(Zt={}));const en="fcm_token_details_db",tn=5,nn="fcm_token_object_Store";
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bn=6048e5;async function wn(e){const t=await async function(e,t){const n=await e.pushManager.getSubscription();if(n)return n;return e.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:Xt(t)})}(e.swRegistration,e.vapidKey),n={vapidKey:e.vapidKey,swScope:e.swRegistration.scope,endpoint:t.endpoint,auth:Qt(t.getKey("auth")),p256dh:Qt(t.getKey("p256dh"))},r=await un(e.firebaseDependencies);if(r){if(function(e,t){const n=t.vapidKey===e.vapidKey,r=t.endpoint===e.endpoint,i=t.auth===e.auth,a=t.p256dh===e.p256dh;return n&&r&&i&&a}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Sn(e){return pn.create("missing-app-config-values",{valueName:e})}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
In("hts/frbslgigp.ogepscmv/ieo/eaylg","tp:/ieaeogn-agolai.o/1frlglgc/o"),In("AzSCbw63g1R0nCw85jG8","Iaya3yLKwmgvh7cF0q4");class En{constructor(e,t,n){this.deliveryMetricsExportedToBigQueryEnabled=!1,this.onBackgroundMessageHandler=null,this.onMessageHandler=null,this.logEvents=[],this.isLogServiceStarted=!1;const r=function(e){if(!e||!e.options)throw Sn("App Configuration Object");if(!e.name)throw Sn("App Name");const t=["projectId","apiKey","appId","messagingSenderId"],{options:n}=e;for(const e of t)if(!n[e])throw Sn(e);return{appName:e.name,projectId:n.projectId,apiKey:n.apiKey,appId:n.appId,senderId:n.messagingSenderId}}(e);this.firebaseDependencies={app:e,appConfig:r,installations:t,analyticsProvider:n}}_delete(){return Promise.resolve()}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Cn(e,t,n){const r=function(e){switch(e){case Zt.NOTIFICATION_CLICKED:return"notification_open";case Zt.PUSH_RECEIVED:return"notification_foreground";default:throw new Error}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(t);(await e.firebaseDependencies.analyticsProvider.get()).logEvent(r,{message_id:n[qt],message_name:n[Gt],message_time:n[Jt],message_device_time:Math.floor(Date.now()/1e3)})}async function kn(e,t){const n=t.data;if(!n.isFirebaseMessaging)return;e.onMessageHandler&&n.messageType===Zt.PUSH_RECEIVED&&("function"==typeof e.onMessageHandler?e.onMessageHandler(vn(n)):e.onMessageHandler.next(vn(n)));const r=n.data;var i;"object"==typeof(i=r)&&i&&qt in i&&"1"===r["google.c.a.e"]&&await Cn(e,n.messageType,r)}const Tn="@firebase/messaging",An="0.12.4",On=e=>{const t=new En(e.getProvider("app").getImmediate(),e.getProvider("installations-internal").getImmediate(),e.getProvider("analytics-internal"));return navigator.serviceWorker.addEventListener("message",(e=>kn(t,e))),t},Bn=e=>{const t=e.getProvider("messaging").getImmediate();return{getToken:e=>_n(t,e)}};
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Q(new b("messaging",On,"PUBLIC")),Q(new b("messaging-internal",Bn,"PRIVATE")),re(Tn,An),re(Tn,An,"esm2017");console.log("Iframe Loaded");const Nn=function(e=function(e=q){const t=J.get(e);if(!t&&e===q&&s())return ne();if(!t)throw ee.create("no-app",{appName:e});return t}()){return Ln().then((e=>{if(!e)throw pn.create("unsupported-browser")}),(e=>{throw pn.create("indexed-db-unsupported")})),X(m(e),"messaging").getImmediate()}(ne({apiKey:"AIzaSyAZ52vwi0JyQi9-I8rsbvefdbuZsUxaW5w",authDomain:"onelinesdktest.firebaseapp.com",projectId:"onelinesdktest",storageBucket:"onelinesdktest.appspot.com",messagingSenderId:"537523308807",appId:"1:537523308807:web:56544f6c4d3a5ae1b61da2",measurementId:"G-56S9V77FTV"}));setTimeout((()=>{Notification.requestPermission().then((e=>{navigator.serviceWorker.register("./sw.js").then((e=>{(async function(e,t){return _n(e=m(e),t)})(Nn,{serviceWorkerRegistration:e}).then((e=>{console.log("Got Token: ",e)})),console.log("Service worker registered")}))}))}),5e3)}();
